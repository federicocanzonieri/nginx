...
if ($connection->connect_errno) {
    ...
    VALUES (1,'John Wick', 'John Wick sta per scatenare l'inferno in terra ...', 2019,'2h 23min'), (2,'Avengers End game', 'Viaggi nel tempo è l unica cosa che ci mancava', 2019,'3h 23min') ";
